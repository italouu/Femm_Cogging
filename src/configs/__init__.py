...
from src.configs.training import NnCfg, FNOConfig, MaskedFNO2dConfig, FNO_GNNConfig, FNO_GNN_v2Config, FNORefConfig, MaskedFNO_GNNConfig, SingleMatFNOConfig, GNN_PostBaseConfig
