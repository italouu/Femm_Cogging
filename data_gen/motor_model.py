...
class BLDC_FEMM_Model(BLDC_Process):
    ...
    def _create_sec(self, r_in, r_ext, ang_in_1, ang_in_2, ang_ext_1=None, ang_ext_2=None,
                    seg_1=True, seg_2=True, material=None, direction=0):

        if ang_ext_1 == None:
            ang_ext_1 = ang_in_1
            ang_ext_2 = ang_in_2

        ang_in_1 = np.deg2rad(ang_in_1)
        ang_in_2 = np.deg2rad(ang_in_2)
        ang_ext_1 = np.deg2rad(ang_ext_1)
        ang_ext_2 = np.deg2rad(ang_ext_2)
...
class BLDC_Shapely_Model(BLDC_Process):
    ...
    def _create_sec(self, r_in, r_ext, ang_in_1, ang_in_2, ang_ext_1=None, ang_ext_2=None,
        ...
        ang_in_1, ang_in_2 = np.deg2rad([ang_in_1, ang_in_2])
        ang_ext_1, ang_ext_2 = np.deg2rad([ang_ext_1, ang_ext_2])
